...
```ts
import { useCreateUser, useListServices, useGetEmployeeAvailability, useCreateAppointment } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser();

const { data, isPending, isSuccess, isError, error } = useListServices();

const { data, isPending, isSuccess, isError, error } = useGetEmployeeAvailability();
...
```js
import { createUser, listServices, getEmployeeAvailability, createAppointment } from '@dataconnect/generated';
...
// Operation GetEmployeeAvailability: 
